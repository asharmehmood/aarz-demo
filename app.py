...
def makeWebhookResult(data):
     ...
     while (i <length):
        ...
        text_data_parts ="Here is record HHHHHHHHHHHH" + str(i+1) +":"+ row_title[i]+" in city "+row_city[i] + " price is "+ str(row_price[i])+ ". For Info about this contact at number "+str(row_number[i]) + "."
